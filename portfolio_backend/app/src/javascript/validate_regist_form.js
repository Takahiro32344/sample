...
setInterval(function () {
    ...
    if (input_flg == 1) {
        ...
        if (window.matchMedia('(min-width: 769px)').matches) {
            if (check_select_PC[0] == true && check_select_PC[1] == true && check_select_PC[1] == true &&
                check[0] == true && check[1] == true && check[2] == true && check[3] == true && check[4] == true && check[5] == true)
                regist = true;
            else
                regist = false;
        } else {
            if (check_select_Phone[0] == true && check_select_Phone[1] == true && check_select_Phone[1] == true &&
                check[0] == true && check[1] == true && check[2] == true && check[3] == true && check[4] == true && check[5] == true)
                regist = true;
            else
                regist = false;
