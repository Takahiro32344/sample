    ...
    <?php
        try {
            ...
            if ($user_data != NULL) {
                ...
                mb_send_mail($_POST['mail'], "ID及びパスワード再設定について", "ID:{$user_data[0]['id_name']}\r\r\rパスワード再設定URL:https://test.jp/test/test/test/reset_password.php?id_name={$user_data[0]['id_name']}");
