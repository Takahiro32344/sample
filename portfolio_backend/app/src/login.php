                        ...
                        <div>
                            ...
                            <div class="btn-pos">
                                <form action="./create_account.php" method="POST">
                                    <button class="regist-btn">アカウント新規作成</button><br>
                                </form>
                                <div>
                            ...
                            <form class="login-1" style="display: none;" action="./index.php" method="POST">
                                <input class="login-id-name" name="id_name">
                                <input class="menu-num" name="menu_num" value=1>
                                <input class="chat-view" name="chat_view" value=1>
                            </form>
