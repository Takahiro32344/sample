                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>";
                                                            if (!empty($_POST['change']) && $_POST['change'] == 1)
                                                                echo "<p class='alert'>変更されませんでした</p>";
                                                            else if (!empty($_POST['change']) && $_POST['change'] == 2)
                                                                echo "<p class='alert'>画像を変更しました</p>";
                                                            echo "<form enctype='multipart/form-data' class='upload-image-PC' action='./update_image.php' method='POST'>
                                            ...
                                            <div class='display-Phone-setting padding'>
                                                ...
                                                <div class='margin-bottom'>
                                                    ...
                                                    if (!empty($_POST['change']) && $_POST['change'] == 1)
                                                        ...
                                                        echo "<p class='alert'>画像を変更しました</p>";
                                                echo "<form enctype='multipart/form-data' class='upload-image-Phone' action='./update_image.php' method='POST'>
                                                        <input type='hidden' name='login_user_id_name' value='$login_user_id_name'>
