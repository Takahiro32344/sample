            ...
            <form class="form_create_account" action="./create_check.php" method="post">
                <div class="form_content_margin">
                    <div>
                        ...
                        <select <?php if (!empty($_POST['select_null_year']) && $_POST['select_null_year'] == '1') echo "style='color: red;'"; ?> name="year">
                        ...
                        <select <?php if (!empty($_POST['select_null_month']) && $_POST['select_null_month'] == '1') echo "style='color: red;'"; ?> name="month">
                            <option>選択してください</option>
                            <?php
                                for ($i = 1; $i <= 12; $i++)
                                    echo "<option>{$i}</option>";
                        ...
                        <select <?php if (!empty($_POST['select_null_day']) && $_POST['select_null_day'] == '1') echo "style='color: red;'"; ?> name="day">
                            <option>選択してください</option>
                            <?php
                                for ($i = 1; $i <= 31; $i++)
                                    echo "<option>{$i}</option>";
                    ...
                    <div>
                        ...
                        <input class="input_email" name="email" placeholder="例:example@gmail.com"> <?php if (!empty($_POST['over_count_email']) && $_POST['over_count_email'] == '1') echo "<br class='display_br'><span class='error_message'>30文字以内で入力してください</span>";  if (!empty($_POST['input_null_email']) && $_POST['input_null_email'] == '1') echo "<br class='display_br'><span class='error_message'>未入力です</span>"; if (!empty($_POST['email_regist_already']) == '1') echo "<br class='display_br'><span class='error_message'>既に登録されております。</span>"; ?>
                    </div><br>
                    <div>
                        <label>居住地</label><br class="display_br">
                        <select <?php if (!empty($_POST['select_null_address1']) && $_POST['select_null_address1'] == '1') echo "style='color: red;'"; ?> name="address1">
                            <option>選択してください</option>
                            <?php
                                $address1 = [
