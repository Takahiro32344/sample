<?php
    for ($j = 0; $j < 400; $j++) {
        ...
        $family_name = [
            ...
            '片桐', '勝又', '加藤', '金沢', '金本', '加納', '笠井', '木下', '菊池', '北川', '北山' ,'北村', '木村', '久米', '北岡', '久米', '日下部', '楠田', '楠木', '倉田',
            ...
            '小野', '小野寺', '小野塚', '鬼久保', '鬼崎', '鬼塚', '櫻井', '佐久間', '陣内', '馬場', '間宮', '内海', '川原', '黒柳', '西条', '仲間', '金子'
        ];
        ...
        if ($gender == '男性')
            $full_name = $family_name[rand(0, 336)] . $name[0][rand(0, 108)];
        else
            $full_name = $family_name[rand(0, 336)] . $name[1][rand(0, 109)];
